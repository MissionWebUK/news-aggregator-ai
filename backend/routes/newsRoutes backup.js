...
router.get("/news-rank", ensureAuthenticated, async (req, res, next) => {
  ...
  console.log("Hitting the newsRoutes news-rank route");
  console.log(req);
...
// Define a GET route for /news-rank
router.get("/preferences", ensureAuthenticated, async (req, res, next) => {

  console.log("Hitting the newsRoutes preferences route");
